...
// Standard iPlug2 standalone-APP resource IDs (menu, about/preferences dialogs,
// debug toggles). These are consumed by third_party/iPlug2/IPlug/APP/IPlugAPP_main.cpp
// and by resources/main.rc, main.rc_mac_dlg, main.rc_mac_menu.
